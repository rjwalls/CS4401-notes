...
**Challenge Unlocking.** In addition to the sequences described above, challenges may have other prerequisites which must be met for the challenge to unlock. For example, some challenges only unlock when the student has earned enough points. Other challenges will only unlock after a certain date. Other challenges only unlock under mysterious circumstances. 
