...
**Challenge time limits.** As we progress through the course, new challenges will be introduced. To earn points, you’ll need to complete each challenge by the deadline posted in the course system. Please note that the system doesn’t allow me to give deadline extensions to individual students. However, if you believe an extension would help you learn better, I’m happy to consider it. Just let me know at the start of the lecture, and be prepared to explain how an extension would benefit your learning. Any extensions granted will apply to all students in the course.
...
**Participation challenges.** There are several ways you can earn points by helping to improve the quality of the course. Before starting any participation challenge, **please reach out to me to confirm that the work you plan to do is enough to earn points.** And as a little bonus for reading this closely, I suggest you ask to join the Hidden Classroom.
...
I would expect a student with a C-level understanding to earn around 2000 points, a B-level understanding to earn around 3000 points, and an A-level understanding to earn around 4500 points. Here’s how these levels generally correspond to the challenges completed:

- **C-level:** 2000 points, including a successful solve of all mandatory challenges. This point total is roughly what you'd earn by solving all lecture challenges, `the-bar`, and two additional basic challenges. You must also demonstrate a C-level of understanding during the oral final exam.
    
- **B-level:** 3000 points, including a successful solve of all mandatory challenges. You'd roughly earn this by solving all lecture challenges, `the-bar`, two additional basic challenges, and five intermediate challenges. You must also demonstrate a B-level of understanding during the oral final exam.
    
- **A-level:** 4500 points, including a successful solve of all mandatory challenges. This point total is typically earned by solving all lecture challenges, `the-bar`, two additional basic challenges, seven intermediate challenges, and two advanced challenges. You must also demonstrate a A-level of understanding during the oral final exam.


### Course Webpage

To submit your challenge flags, please use the course infrastructure web frontend, also known as the course webpage. The webpage features a scoreboard where you can track your progress alongside your peers. When setting up your account, make sure to use your WPI username as your _username_. However, feel free to choose a pseudonym for your _display name_ if you prefer. **Don't forget to join the `CS557-2024` classroom on the course webpage to access the challenges!**

### Study Buddies

You have the option to choose a study buddy for the duration of the course. With your study buddy, you’re free to discuss challenge solutions and even help each other debug code. However, please remember that you cannot directly share solution scripts or flags with your buddy.
...
I don't recommend taking both CS4401 and CS557. If you have the option, I encourage you to choose CS557.
