...
Below is a list of topics and lecture materials for this course. It's quite an extensive list, and it's possible that we may not have sufficient time to cover everything during the lecture. To help you prioritize your efforts, please note that any materials marked as "required" will be most useful in helping you solve challenges and earn points. Therefore, it's advisable to focus on those materials first. Materials marked as "optional" may also have useful information for challenging solving, but they may contain information that others may find interesting, but not directly helpful for challenge solving.
