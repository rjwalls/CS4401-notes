...
will be adjusted throughout the semester. It was last updated on **April 7,
2022.**
...
**Released challenges:**
 - `Mine4Shell` with deadline **May 3, 17:20 EST**
...
ASLR is disabled, and how to deal with null bytes in your input.
 - LiveOverflow's ["A simple Format String exploit
   example"][liveoverflow_format1]. This is an good introductory video on
...
**Released challenges:**
 ...
 - `heap3r` with deadline **Apr. 26, 17:20 EDT**
 - `Not so random` with deadline **May 3, 17:20 EST** 
 - `canary` with deadline **May 3, 17:20 EDT** 
 - `format0r-64` with deadline **Apr. 29, 17:20 EDT**
 - `format1r` with deadline **Apr. 29, 17:20 EDT**
 - `format2r` with deadline **Apr. 29, 17:20 EDT**
 - `format3r` with deadline **Apr. 29, 17:20 EDT**
