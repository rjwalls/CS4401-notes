...
will be adjusted throughout the semester. It was last updated on **August 29,
2022.**
...
These notes describe the basic concepts you need to start solving the `stack0r-64`, `stack1r-64`, and `stack2r-64` 
lecture challenges.
 - [Quick Notes: GDB
...
#### Topic: Control-flow Hijacking and Code Injection 
...
**Released challenges:** 
 ...
 - `stack4r` with deadline **Sep. 7, 17:20 EDT**
 - `stack4r-64` with deadline **Sep. 7, 17:20 EDT**
 - `stack4r-revenge` with deadline **Dec. 12, 17:20 EDT**
 - `nyan` with deadline **Dec. 12, 17:20 EDT**

### Lecture 05-06

#### Topic: Shellcoding continued 
