...
**Released challenges:**
 ...
 - `heap-smash` with deadline **May 11, 15:00 EDT**
 - `save_the_bees` with deadline **May 11, 15:00 EDT**
...
Required material:
 ...
 - [Lecture Notes: Global Offset Table][notes_got]
...
**Released challenges:**
 - `heap3r-64` with deadline **April 20, 15:00 EDT**
 - `sleepy-holder` with deadline **May 11, 15:00 EDT**
 - `fastfurious` with deadline **May 11, 15:00 EDT**
...
Required material:
 ...
 - ["Format String to dump binary and gain RCE - 33c3ctf ESPR (pwn
   150)"][liveoverflow_format]. This challenge is more difficult than the
...
**Released challenges:**
 - `format0` with deadline **April 23, 15:00 EDT**
 - `format1` with deadline **April 23, 15:00 EDT**
 - `format2` with deadline **April 23, 15:00 EDT**
 - `format3` with deadline **April 23, 15:00 EDT**

[liveoverflow_format]:https://www.youtube.com/watch?v=XuzuFUGuQv0
...
**Released challenges:**
 - `format4` with deadline **April 27, 15:00 EDT**
 ...
 - `global_domination` with deadline **May 11, 15:00 EDT.**
