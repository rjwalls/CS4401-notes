...
solve challenges and earn points. I expect you to have read all such materials. 
 - [Lecture Notes: Getting Started.](http://cs4401.walls.ninja/notes/lecture/getting_started.html)
This set of notes introduces the course infrastructure and describes the recommended setup for solving challenge binaries. In
