...
`stack0r-64-557`, `stack1r-64-557`, and `stack2r-64-557` lecture challenges.
...
**Related challenges:**
 - Lecture Sequence: `stack0r-64-557`, `stack1r-64-557`,
   `stack2r-64-557`, `stack3r-64`.
 - Sequence: `bandit0-12` introductory level, `bandit13-20` basic level, `bandit21-33` basic level
 - After Stack 0: `stack0r-guessdown-557`, basic level.
 - After Stack 2 and the Ghidra mini-lab: `stack2r-warp-drive-557`, basic level.
...
### Topic: Recurring Advanced Topics and Defenses
...
**Related challenges:**
 ...
 - `dog-house`, advanced level
 - `Shadow Strike`, advanced level
