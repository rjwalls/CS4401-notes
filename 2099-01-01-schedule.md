...
Below is a list of topics and lecture materials for this course. It's quite an extensive list, and it's likely we will not have sufficient time to cover everything. To help you prioritize your efforts, please note that any materials marked as "required" will be most useful in helping you solve challenges and earn points. Therefore, it's advisable to focus on those materials first. Finally, the preliminary set and order of released challenges will vary from what is shown below.
...
**Released challenges:**
 ...
 - Sequence: `pokemon` introductory level, `pokemon-gotta-chatem-all` basic level, pokemon-rematch` intermediate level
 - Sequence: `bandit0-12` introductory level, `bandit13-20` basic level, `bandit21-33` basic level 
 - `michael-scott`, participation
 - `stack0-guessdown`, basic level
 - `stack2-warp-drive`, basic level
...
**Released challenges:**
 ...
 -  `stack4r-lifesupport` intermediate level
...
**Released challenges:**
 ...
 - Participation challenges `hackerman` and `stockholm-syndrome`
