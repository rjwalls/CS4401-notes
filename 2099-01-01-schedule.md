...
will be adjusted throughout the semester. It was last updated on **April 14,
2022.**
...
**Title:** Embedded Security Workshop

**Speaker:**  Brian Flanagan

**Abstract:** During this one-hour workshop we will talk to your members about
working in embedded security as well as discuss the Embedded Capture the Flag
Competition (eCTF) that MITRE has run for years. We will then transition to a
hands-on workshop where students get to learn about side-channel analysis
through attempting a simple power analysis (SPA) attack. There will also be an
opportunity for a Q&A about MITRE, cybersecurity, the transition from college
to the workforce, and anything else. 
