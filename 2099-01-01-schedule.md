...
Below is a list of topics and lecture materials for this course. **Discussion
materials** should be reviewed **prior** to that day's lecture. **Technical
material** are best read **after** that day's lecture.  Keep in mind that the
schedule will be adjusted throughout the semester. It was last updated on
**Apr. 22, 2021.**
...
**Released challenges:**
 - `pokemon` with deadline **May 10, 17:20 EDT**
 - All participation challenges with deadline **May 13, 17:20 EDT** 
...
**Released challenges:**
 - `stack0r-64` with deadline **Apr. 8, 17:20 EDT**
 - `stack1r-64` with deadline **Apr. 8, 17:20 EDT**
 - `stack2r-64` with deadline **Apr. 8, 17:20 EDT**
...
Required material:
 - [Lecture Notes: Basics of Buffer
   Overflows.](http://cs4401.walls.ninja/notes/lecture/basics_bufferoverflows.html) I assigned these notes in the previous lecture, but we still need to cover return address, PIE binaries, and setuid binaries. 
...
- [Quick Notes: Help: My Exploit Works in GDB, but not on the
 ...
 Optional material:
 - [Lecture Notes: The Stack and Local Variables][lecture-binexec1]. This video primarily covers material we have introduced already in the lectures, but it might be a useful review.  
...
**Released challenges:** 
 - `stack3r-64` with deadline **Apr. 12, 17:20 EDT**
 - `heap0r-64`  with deadline **Apr. 12, 17:20 EDT**
 - `authenticate` with deadline **May 10, 17:20 EDT**
...
**Released challenges:**
 - `stack4r-64` with deadline **Apr. 15, 17:20 EDT**
 - `spqr` with deadline **May 10, 17:20 EDT**
...
**Released challenges:**
 - `stack5r-64` with deadline **Apr. 19, 17:20 EDT**
 - `stack6r` with deadline **Apr. 19, 17:20 EDT**
 - `stack6r-64` with deadline **Apr. 19, 17:20 EDT**
...
**Released challenges:**
 - `heap1r-64` with deadline **Apr. 22, 17:20 EDT**
 - `heap2r-64` with deadline **Apr. 22, 17:20 EDT**
 - `heap2s-64` with deadline **Apr. 22, 17:20 EDT**
 - `ssp_buffer_r2` with deadline **May 10, 17:20 EST**
 - `Not so random` with deadline **May 10, 17:20 EST** 
...
**Released challenges:**
 ...
 - `canary` with deadline **May 10, 17:20 EDT** 
 - `needle-search` with deadline **May 10, 17:20 EDT**
...
**Released challenges:**
 ...
 - `the-bar` with deadline **May 10, 17:20 EDT.** **This challenge must be
   solved in order to pass the course!**
 - `argument-clinic` with deadline **May 10, 17:20 EDT**
 - `wargames` with deadline **May 10, 17:20 EDT**
 - `wargames-reloaded` with deadline **May 10, 17:20 EDT**
...
**Released challenges:**
 - `dorsia1` with deadline **May 10, 17:20 EDT**
 - `et-tu-brute` with deadline **May 10, 17:20 EDT**
 - `slither` with deadline **May 10, 17:20 EDT**
 - `stopwatch` with deadline **May 10, 17:20 EDT**.
 - `forking-canaries` with deadline **May 10, 17:20 EDT**. Hint: this challenge
