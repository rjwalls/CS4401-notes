...
**Released challenges:**
 - `format0r-64` with deadline **Sep. 29, 2022**
 - `format1r-64` with deadline **Oct. 3, 2022**
 - `format2r-64` with deadline **Oct. 6, 2022**
 - `ssp-buffer-size` with deadline **Dec. 12, 17:20 EST**
...
**Released challenges:**
 - `heap0r-64`  with deadline **Oct. 27, 17:20 EDT**
 - `heap1r-64` with deadline **Oct. 13, 17:20 EDT**
 - `heap2r-64` with deadline **Oct. 27, 17:20 EDT**
 - `heap2s-64` with deadline **Oct. 27, 17:20 EDT**
 - `bon-nie-appetit` (lecture) with deadline **Dec. 12, 17:20 EDT**
