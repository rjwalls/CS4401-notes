...
Below is a list of topics and lecture materials for this course. It's quite an extensive list, and it's likely we will not have sufficient time to cover everything. To help you prioritize your efforts, please note that any materials marked as "required" will be most useful in helping you solve challenges and earn points. Therefore, it's advisable to focus on those materials first. Finally, the set and order of released challenges will vary from what is shown below.
